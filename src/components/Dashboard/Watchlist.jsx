...
const Watchlist = ({ loading }) => {
	...
	return (
		<div className="mt-4  p-10 bg-[var(--background-100)] shadow-md rounded-lg relative transition-all duration-500 ease-in-out">
			{loading ? (
				...
				<ul className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-h-[45vh] overflow-y-auto scrollable-content">
